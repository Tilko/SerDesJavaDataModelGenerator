...
File  -> Import Projects from File System or Archive  ->  Directory...

Errors are generated by Java assertion ("assert" keyword), s, for each "main" function that use this tool, make sure you enable them by doing:   
...
(with right-click -> refresh). Or just setup the eclipse option:    
