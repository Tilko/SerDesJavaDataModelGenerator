...
public class ParserGeneration {
	...
	private static void generateParser() throws IOException {
		...
		File currentFolder = new File("src/main/java/org/gmart/codeGen/javaGen/modelExtraction/parserGenTestForBug");
		String g4SourcePath = new File(currentFolder, "DataTypeHierarchy2.g4").getCanonicalPath();
