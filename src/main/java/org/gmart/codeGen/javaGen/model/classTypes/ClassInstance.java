...
public interface ClassInstance {
	AbstractClassDefinition getClassDefinition();
	
	default ReferenceCheckResult checkReferences_recursive() {
		return getClassDefinition().checkReferences_recursive(this);
	}
}
