...
@Generated("")
public class Transition3 implements ClassSerializationToYamlDefaultImpl, ClassInstance, AbstractClassDefinition.DependentClassInstance, AbstractClassDefinition.DependentInstanceSourceClass {
    private static AbstractClassDefinition classSpecification;

    private String condition;

    private KeysFor_Object<List<Transition3>> target;
    ...
    public KeysFor_Object<List<Transition3>> getTarget() {
        return target;
    }

    public void setTarget(KeysFor_Object<List<Transition3>> target) {
        this.target = target;
